---
description: RFP 또는 참고 문서를 등록하고 txt 추출 및 섹션 분리까지 수행합니다
---
...
## 섹션 목록
- [section-01.md](section-01.md) — [섹션 제목]
- [section-02.md](section-02.md) — [섹션 제목]
...
...
- 원문 텍스트를 최대한 보존하되, 가독성을 위해 마크다운 형식으로 정리한다
