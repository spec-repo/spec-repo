...
**사용법**:
- `/specrepo-review <문서명>` → 검토 요청 태그 생성
- `/specrepo-review approved <문서명>` → 고객 승인 완료 태그 생성

예) `/specrepo-review 요구사항정의서`, `/specrepo-review approved 요구사항정의서`
...
3. 실행 결과를 보여준다
   ...
   - 다음 단계 안내 (`review` 완료 시 고객 검토 후 `/specrepo-review approved <문서명>` 실행)
