...
**사용법**:
- `/sp-design-arch draft` — RFP + 요구사항 → 아키텍처설계서.md 초안 생성
- `/sp-design-arch import <file>` — 기존 PDF/docx → MD 구조화
- `/sp-design-arch export [--format pdf|docx]` — MD → 산출물 파일 생성
- `/sp-design-arch status` — 현황 확인
...
`skills/sp-design-arch/data/아키텍처설계서-template.md`를 Read해서 섹션 구조를 파악한 후, 프로젝트에 맞게 내용을 채워 `references/02-design/아키텍처설계서.md`를 생성한다.
